...
net = tflearn.fully_connected(net, 64,name="layer1")
net = tflearn.dropout(net, 0.5.name="layer2")
net = tflearn.fully_connected(net, number_classes, activation='softmax',names="layer3")
net = tflearn.regression(net, optimizer='adam', loss='categorical_crossentropy')

model = tflearn.DNN(net)
model = tflearn.DNN(net, tensorboard_verbose=3, tensorboard_dir="C:\Users\kpeddolla\test")
